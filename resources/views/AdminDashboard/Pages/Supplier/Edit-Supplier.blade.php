...
@section('title', 'Update Supplier Page')
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="company_name"
                                                        id="company_name" placeholder="Enter Supplier Company Name" value="{{ $new->company }}" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="supplier_name"
                                                        id="supplier_name" placeholder="Enter Supplier Name" value="{{ $new->name }}" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="gst_no" id="gst_no"
                                                        placeholder="Enter Product Price" value="{{ $new->gst_no }}" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control" name="email" id="email"
                                                        placeholder="Enter Email" value="{{ $new->email }}" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="phone" id="phone"
                                                        placeholder="Enter Phone No." value="{{ $new->phone }}" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea type="text" class="form-control" name="address" id="address" placeholder="Enter Address">{{ $new->address }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="city" id="city"
                                                        placeholder="Enter city" value="{{ $new->city }}" />
        ...
        $(document).ready(function() {
            ...
            $('#SupplierForm').on('submit', function(e) {
                ...
                if (isValid) {
                    ...
                    $.ajax({
                        url: '{{ route('update.supplier',$new->id) }}',
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
